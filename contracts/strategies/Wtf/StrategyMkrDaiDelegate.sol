...
contract StrategyMkrDaiDelegate {
    ...
    constructor(address _controller, string memory _name) public {
        name = _name;
    ...
    function _approveAll() internal {
        ...
        IERC20(dai).approve(yVaultDAI, MAX);
    ...
    function getmVaultRatio(uint256 amount) public view returns (uint256) {
        ...
        uint256 delayedCPrice = spot.mul(liquidationRatio).div(1e27);
        // ray
        ...
        uint256 numerator = _balance.mul(delayedCPrice).div(1e18);
        // ray
